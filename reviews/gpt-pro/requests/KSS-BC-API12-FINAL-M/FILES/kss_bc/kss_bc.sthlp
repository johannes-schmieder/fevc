...
sides. If measured whitening or anchor-inverse error cannot certify a pivot,
or a row score is numerically ambiguous at the eligibility cutoff, the command
withholds as {cmd:AMBIGUOUS_CONTROL_BASIS}. It uses the coefficient-one

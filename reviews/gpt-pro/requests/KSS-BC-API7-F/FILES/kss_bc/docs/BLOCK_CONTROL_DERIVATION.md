...
by more than the registered numerical tolerance. It reports the lower bound

\[
\texttt{deletion_rank_gap}
=1-\max_g\operatorname{tr}(L_g)>0.
\]

This condition implies every $G_{-g}$ is positive definite. If a nonzero

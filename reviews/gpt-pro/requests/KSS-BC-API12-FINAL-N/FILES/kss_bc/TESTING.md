...
The suites include the source-bound API10--API12 counterexamples: explicit and
...
anchor-boundary control-basis maps at `probes(2)`, maximum allowed tolerance,
final corrected-row overflow, physical-copy allocation withholding, frequency
regrouping, and stale-runtime rejection.

...
- `AMBIGUOUS_CONTROL_BASIS` when measured whitening or anchor-inverse error is
  too large to certify the canonical row anchor, or a pivot score lies within
  the numerical uncertainty envelope of its eligibility cutoff;

...
reciprocal condition number when joint controls were prepared.
...
control block retains rank after every declared deletion, conditional on the
graph certificate for the FE block.

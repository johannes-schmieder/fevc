...
if !_rc {
    ...
    do `"`pkgroot'/tests/stata/test_rust_observation_full_cmg.do"' `"`pkgroot'"'
    do `"`pkgroot'/tests/stata/test_rust_pooled_full_cmg.do"' `"`pkgroot'"'
    do `"`pkgroot'/tests/stata/test_rust_point_routes_full_cmg.do"' `"`pkgroot'"'
    do `"`pkgroot'/tests/stata/test_rust_controlled_full_cmg.do"' `"`pkgroot'"'
    do `"`pkgroot'/tests/stata/test_rust_execution_paths.do"' `"`pkgroot'"'
    do `"`pkgroot'/tests/stata/test_stayer_option_symmetry.do"' `"`pkgroot'"'
...
do `"`pkgroot'/tests/stata/test_pooled_deletion.do"' `"`pkgroot'"' `suite'

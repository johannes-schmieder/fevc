...
capture noisily fevc_rust prepare empty_input1 empty_input2       ///
...
fevc_rust release `disconnected_handle'
fevc_rust snapshot
assert r(state) == 0
...
fevc_rust solve `handle', seed(91827) probes(6)                     ///
...
di as result "FEVC RUST PLUGIN PASS"
exit 0

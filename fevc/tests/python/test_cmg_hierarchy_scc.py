...
ALLOWLIST = ROOT / "fevc/benchmarks/scale_bundle_allowlist.txt"
...
def test_hierarchy_scc_files_and_robust_families_are_bundled() -> None:
    ...
    assert {
        "fevc/benchmarks/scc/run_cmg_hierarchy.sge",
        "fevc/benchmarks/scc/submit_cmg_hierarchy.sh",
        "fevc/benchmarks/scc/validate_cmg_hierarchy.py",
        "fevc/cmg/benchmarks/hierarchy_benchmark.do",
    } <= allowlist
    benchmark = (
        ROOT / "fevc/cmg/benchmarks/hierarchy_benchmark.do"

...
def validate_role(job_dir: Path, label: str, task: dict[str, str], task_sha: str,
    ...
    require(status.get("schema") ==
            "FEVC-CMG-CANDIDATE-QUALIFICATION-ROLE-STATUS-V2" and
    ...
    require(result.get("schema") == "FEVC-CMG-CANDIDATE-QUALIFICATION-STATA-V3" and
    ...
    require(tree.get("schema") == "FEVC-COMPARATIVE-SCALING-PROCESS-TREE-V1" and
...
def validate(run_dir: Path, task_id: int, qacct_path: Path) -> dict[str, Any]:
    ...
    require(input_receipt.get("schema") == "FEVC-COMPARATIVE-SCALING-INPUT-V6" and
    ...
    require(preparation.get("schema") ==
            "FEVC-CMG-CANDIDATE-QUALIFICATION-PREPARATION-QACCT-V2" and

...
TASK_SCHEMA = "FEVC-CMG-CANDIDATE-QUALIFICATION-TASK-V2"
RESULT_SCHEMA = "FEVC-CMG-CANDIDATE-QUALIFICATION-RESULT-V2"
NODE_SCHEMA = "FEVC-CMG-CANDIDATE-QUALIFICATION-NODE-V3"
ACCEPTANCE_SCHEMA = "FEVC-CMG-CANDIDATE-QUALIFICATION-ACCEPTANCE-V2"
RUN_SCHEMA = "FEVC-CMG-CANDIDATE-QUALIFICATION-RUN-V2"
STRUCTURES = {
    "strong_d2": ("strong", 2),
    "strong_d3": ("strong", 3),
    "strong_d6": ("strong", 6),

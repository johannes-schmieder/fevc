...
```sh
./.venv/bin/python fevc/benchmarks/prep_rhs1/run_local.py \
  --candidate "$(git rev-parse HEAD)" \
  --output-dir /private/tmp/fevc-prep-rhs1-local
```
...
```sh
./.venv/bin/python fevc/benchmarks/prep_rhs1/analyze_scc.py \

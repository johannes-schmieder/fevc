...
```bash
./.venv/bin/python fevc/benchmarks/full_cmg_spike/run_local.py \
  --output-dir /private/tmp/fevc-full-cmg-local-1e3a412 \
  --baseline 4124b34f3ca216dcc3aae27e4b31bbac9e011f11 \
  --baseline-plugin /private/tmp/fevc-baseline-4124-exact/plugin/vckss_rust_macos_arm64.plugin \
  --candidate 7d34df221fdf1a13f868ab9606a1de4ab6bf940f \
  --candidate-plugin /private/tmp/fevc-full-cmg-7d34df2/candidate/vckss_rust_macos_arm64.plugin \
  --candidate-build-receipt /private/tmp/fevc-full-cmg-7d34df2/build-receipt.txt \

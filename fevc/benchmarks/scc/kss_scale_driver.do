...
if inlist("`fixture'", "replicated_blocks", "ring") & `scale_factor' >= 2 {
    ...
    quietly do "`c(pwd)'/fevc/benchmarks/kss_scale_fixtures.mata"
    quietly do "`c(pwd)'/fevc/benchmarks/kss_scale_fixtures.do"
    ...
    // remove the fixture runtime now so fevc can load its registered
...
capture noisily fevc y_minus_xb `weight_spec', `command_options'

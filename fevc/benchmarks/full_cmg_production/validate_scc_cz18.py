...
ROUNDS = (
    ("00-cold", "cold", ("fevc", "matlab")),
    ("01-warm", "warm", ("matlab", "fevc")),
    ("02-warm", "warm", ("fevc", "matlab")),
    ("03-warm", "warm", ("matlab", "fevc")),
    ("04-warm", "warm", ("fevc", "matlab")),
    ("05-warm", "warm", ("matlab", "fevc")),
)
...
def main() -> int:
    ...
    rows: dict[str, list[dict[str, Any]]] = {"fevc": [], "matlab": []}
    ...
    for round_name, temperature, roles in ROUNDS:
        ...
        stata_root = round_root / "fevc"
        stata = one_csv(stata_root / "stata.csv")
        require(stata["schema"] == "FEVC-FULL-CMG-PRODUCTION-CZ18-STATA-V1"
    ...
    promotion_gates = {
        ...
        "peak_rss_no_greater_than_matlab_gate": rss_medians["fevc"] <= rss_medians["matlab"],
        "common_probe_private_winner_gate": common_probe_private_winner_gate,
    }
    summary = {
        "schema": "FEVC-FULL-CMG-PRODUCTION-CZ18-SCC-VALIDATION-V1",

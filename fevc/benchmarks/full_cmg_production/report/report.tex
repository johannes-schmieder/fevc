...
presented as pathwise equality. The common-probe private comparisons pass the
registered equivalence rule.

Data, caller RNG, sort RNG,
...
rust/stata_backend/qualify_macos.sh \
  --receipt /private/tmp/fevc-alpha-4dafec6-macos-receipt.txt \
  --artifacts-dir /private/tmp/fevc-alpha-4dafec6-macos-artifacts
...
\path{fevc/benchmarks/full_cmg_production/evidence/} and
\path{rust/qualification/evidence/}. Raw SCC runs remain under
\path{/projectnb/welfgr/fevc/runs/}; disposable build/log caches are excluded

...
def main() -> None:
    ...
    result = {
        "schema": "FEVC-PROJECTION-AKM-STAGE-V1",
    ...
    marker.write_text(f"FEVC PROJECTION AKM STAGE COMPLETE {args.stage} {args.job_id}\n", encoding="utf-8")
    if result["status"] == "PASS":
        (args.run_dir / "receipts" / f"{args.stage}.pass").write_text(
            f"FEVC PROJECTION AKM STAGE PASS {args.stage} {args.job_id}\n",
            encoding="utf-8",
        )

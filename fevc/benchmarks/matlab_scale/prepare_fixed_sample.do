...
confirm file `"`source_root'/fevc/benchmarks/kss_scale_fixtures.do"'
confirm file `"`source_root'/fevc/benchmarks/kss_scale_fixtures.mata"'
...
quietly do `"`source_root'/fevc/benchmarks/kss_scale_fixtures.mata"'
quietly do `"`source_root'/fevc/benchmarks/kss_scale_fixtures.do"'

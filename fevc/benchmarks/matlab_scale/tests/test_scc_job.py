...
def scheduler_fixture(tmp_path):
    job_dir = "/projectnb/welfgr/fevc/runs/test/matlab_scale/scale4-well/cold"
    source_dir = "/projectnb/welfgr/fevc/bundles/" + "2" * 64 + "/source"
    script_path = source_dir + "/fevc/benchmarks/matlab_scale/run_matlab_scale.sge"
    stdout_path = (
        "/projectnb/welfgr/fevc/runs/test/logs/"
    ...
    request_values = {
        ...
        "bundle_sha256": "2" * 64,
        "input_path": (
            "/projectnb/welfgr/fevc/runs/test/matlab_scale/"
        ...
        "qacct_path": "/projectnb/welfgr/fevc/runs/test/qacct/matlab_scale_scale4-well_cold.txt",
        "automatic_cascade": "disabled",
    }
    request_path = tmp_path / "request.tsv"
    write_receipt(request_path, request_values)
    scheduler_environment = {
        "KSS_MS_RUN_DIR": "/projectnb/welfgr/fevc/runs/test",
        ...
        "KSS_MS_MODE": "cold",
        "KSS_MS_CASE_JSON": (
            "/projectnb/welfgr/fevc/runs/test/matlab_scale/scale4-well/case.json"
        ),

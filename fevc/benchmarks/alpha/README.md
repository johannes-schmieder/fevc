# FEVC alpha benchmark protocol

`FEVC-ALPHA-BENCH-V2` is the maintained M6 benchmark and report workflow.
...
```bash
python3 fevc/benchmarks/alpha/run_local.py \
  --output /private/tmp/fevc-alpha-benchmark
python3 fevc/benchmarks/alpha/analyze.py \
  --run-root /private/tmp/fevc-alpha-benchmark \
  --output /private/tmp/fevc-alpha-report
```

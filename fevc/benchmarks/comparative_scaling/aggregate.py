...
RESULT_FIELDS = (
    ...
    "schur_seconds", "pcg_seconds", "rust_ingest_seconds",
    "rust_canonicalize_seconds", "rust_graph_seconds", "rust_compress_seconds",
    "rust_plan_seconds", "rust_stayer_augmentation_seconds", "rust_solve_seconds",
    "rust_native_total_seconds", "estimator_phase_peak_rss_bytes",
...
def role_row(payload: dict[str, Any], role: str) -> dict[str, Any]:
    ...
    return {
        ...
        **{name: blank(value.get(name)) for name in (
            ...
            "rust_ingest_seconds", "rust_canonicalize_seconds",
...
def preparation_identity(run_dir: Path, source_commit: str,
    ...
    require(preparation.get("schema") ==
            "FEVC-COMPARATIVE-SCALING-PREPARATION-V2" and
    ...
    require(preparation_qacct.get("schema") ==
            "FEVC-COMPARATIVE-SCALING-PREPARATION-QACCT-V2" and
    ...
    sources = [
        ...
        run_dir / "source" / "fevc" / "benchmarks" /

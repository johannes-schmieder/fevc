...
try
    ...
    identity = struct('schema','FEVC-COMPARATIVE-SCALING-MATLAB-PROCESS-V1', ...
    ...
    record = struct('schema','FEVC-COMPARATIVE-SCALING-MATLAB-V1', ...
    ...
    fprintf('FEVC COMPARATIVE SCALING MATLAB PASS: %s\n',experiment);
catch exception
    ...
    failure = struct('schema','FEVC-COMPARATIVE-SCALING-MATLAB-FAILURE-V1', ...

...
ARTIFACT_SOURCE_SCHEMA = "FEVC-COMPARATIVE-SCALING-ARTIFACT-SOURCE-V2"
PREPARATION_SCHEMA = "FEVC-COMPARATIVE-SCALING-PREPARATION-V2"
PREPARATION_QACCT_SCHEMA = "FEVC-COMPARATIVE-SCALING-PREPARATION-QACCT-V2"
SHARED_FIELDS = (
    "source_commit",
    "bundle_sha256",
...
def safe_replacement_path(path: str) -> bool:
    ...
    protected_build_inputs = {
        "fevc/benchmarks/comparative_scaling/build_benchmark_ado.py",
        "fevc/benchmarks/comparative_scaling/prepare_artifacts.sge",
        "fevc/benchmarks/comparative_scaling/prepare_matlab_mex.m",
    }
    return (
        ...
        and (
            ...
            or path.startswith("fevc/benchmarks/comparative_scaling/")
        )
    )

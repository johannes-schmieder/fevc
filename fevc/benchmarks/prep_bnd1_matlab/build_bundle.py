...
ALLOWLIST = PurePosixPath(
    "fevc/benchmarks/prep_bnd1_matlab/bundle_allowlist.txt"
)
...
def read_paths(root: Path) -> list[PurePosixPath]:
    ...
    package = root / "fevc/fevc.pkg"
    runtime = {
        PurePosixPath("fevc") / line.removeprefix("f ").strip()
    ...
    required = {
        ALLOWLIST,
        PurePosixPath("fevc/benchmarks/prep_bnd1_matlab/build_bundle.py"),
        PurePosixPath("fevc/benchmarks/prep_bnd1_matlab/run_pair.sge"),
        PurePosixPath(
            "fevc/benchmarks/prep_bnd1_matlab/run_dense_oracle.sge"
        ),
        PurePosixPath("fevc/benchmarks/prep_bnd1_matlab/stata_run.do"),
        PurePosixPath("fevc/benchmarks/prep_bnd1_matlab/generate_input.do"),
        PurePosixPath("fevc/benchmarks/prep_bnd1_matlab/prep_bnd1_matlab_run.m"),
        PurePosixPath(
        ...
        PurePosixPath("fevc/benchmarks/oracle/stata_oracle.do"),
        PurePosixPath("fevc/benchmarks/oracle/vckss_dense_oracle.m"),
        ...
        PurePosixPath("fevc/benchmarks/scc/verify_numopt2_matlab_source.py"),
    }

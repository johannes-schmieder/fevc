...
clear
set obs 1
generate str48 schema = "FEVC-MATLAB-2026-INPUT-V1"
...
generate str32 sample_contract = "same_literal_match_rows_v3"
generate str32 target_contract = "uniform_stored_rows_v1"
export delimited using `"`receipt_csv'"', replace
di as result "FEVC_MATLAB_2026_INPUT_PASS `structure' rows=`rows'"
exit 0

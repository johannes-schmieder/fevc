...
This catalog preserves the dated descriptions previously accumulated in the
documentation index through September 10, 2026. Statements such as “current,”
“pending,” or “next” below describe their original checkpoint, not today's
instructions. Later results do not erase earlier failures or qualify a newer
source automatically. Reports, registrations and exact-source receipts remain
unchanged at their existing paths.

Use [the documentation index](README.md) for active contracts and
[the current plan](../PLAN.md) for outstanding work.

## Dated registrations and checkpoints

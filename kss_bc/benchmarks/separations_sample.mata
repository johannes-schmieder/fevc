...
struct kssbc_sep__bridge_result
{
    real colvector bad_row
    real scalar count
}

struct kssbc_sep__bridge_result scalar kssbc_sep__match_bridges(
    real colvector worker,
    real colvector firm,
    real colvector active)
{
    struct kssbc_sep__bridge_result scalar out
...
void kssbc_sep__stata_prune_bridges(
...
{
    struct kssbc_sep__bridge_result scalar bridges
    ...
    bridges = kssbc_sep__match_bridges(worker,firm,active)
    if (bridges.count > 0) {

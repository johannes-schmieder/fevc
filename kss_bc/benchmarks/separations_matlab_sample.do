...
confirm file `"`package_root'/kss_bc.mata"'
...
file open `marker' using `"`output_dir'/prepare.stata.pass"', ///
    write text replace
file write `marker' ///
    "KSS_BC MATLAB SAMPLE PREPARE PASS `label' `source_commit'" _n
file close `marker'
di as result "KSS_BC MATLAB SAMPLE PREPARE PASS: `label'"
exit 0

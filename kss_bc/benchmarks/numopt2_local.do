...
args source_root output_csv source_label source_commit
...
confirm file `"`source_root'/kss_bc/kss_bc.ado"'
adopath ++ `"`source_root'/kss_bc"'
...
forvalues run = 1/4 {
    ...
    matrix receipt[`run',33] = (vec(one_result)',`result_difference')
...
di as result "KSS_NUMOPT2_LOCAL_PASS `source_label' `source_commit'"
exit 0

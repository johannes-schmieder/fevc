...
def scheduler_fixture(tmp_path):
    job_dir = "/projectnb/welfgr/kss-bc/runs/test/matlab_scale/scale4-well/cold"
    source_dir = "/projectnb/welfgr/kss-bc/bundles/" + "2" * 64 + "/source"
    script_path = source_dir + "/kss_bc/benchmarks/matlab_scale/run_matlab_scale.sge"
    stdout_path = (
        "/projectnb/welfgr/kss-bc/runs/test/logs/"
    ...
    request_values = {
        ...
        "bundle_sha256": "2" * 64,
        "input_path": (
            "/projectnb/welfgr/kss-bc/runs/test/matlab_scale/"
        ...
        "qacct_path": "/projectnb/welfgr/kss-bc/runs/test/qacct/matlab_scale_scale4-well_cold.txt",
        "automatic_cascade": "disabled",
    }
    request_path = tmp_path / "request.tsv"
    write_receipt(request_path, request_values)
    scheduler_environment = {
        "KSS_MS_RUN_DIR": "/projectnb/welfgr/kss-bc/runs/test",
        ...
        "KSS_MS_MODE": "cold",
        "KSS_MS_CASE_JSON": (
            "/projectnb/welfgr/kss-bc/runs/test/matlab_scale/scale4-well/case.json"
        ),

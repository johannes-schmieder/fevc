...
confirm file `"`source_root'/kss_bc/benchmarks/kss_scale_fixtures.do"'
confirm file `"`source_root'/kss_bc/benchmarks/kss_scale_fixtures.mata"'
...
quietly do `"`source_root'/kss_bc/benchmarks/kss_scale_fixtures.mata"'
quietly do `"`source_root'/kss_bc/benchmarks/kss_scale_fixtures.do"'
...
if `scale' > 1 {
    kssbc_scale_fixture, design(`topology') copies(`scale') ///

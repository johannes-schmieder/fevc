...
def validate_reference_record(record, preparation, *, probes, seed):
    ...
    require(record.get("kind") == "stata_kss_bc", "reference kind was not derived from KSS")
...
def validate_case(binding, contract):
    ...
    require(reference.get("kind") == "stata_kss_bc", "case reference kind is not KSS-derived")

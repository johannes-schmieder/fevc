...
builder="$source_dir/kss_bc/benchmarks/scc/build_cmg_primary_manifest.py"
stata_submit="$source_dir/kss_bc/benchmarks/scc/submit_numopt2_scale.sh"
matlab_submit="$source_dir/kss_bc/benchmarks/scc/submit_numopt2_matlab.sh"
test -f "$builder"
test -x "$stata_submit"

...
case "$input_csv" in /projectnb/welfgr/kss-bc/runs/*) ;; *) exit 198 ;; esac
...
profiler="$source_dir/kss_bc/benchmarks/separations_matlab_phase_profile.m"
wrapper="$source_dir/kss_bc/benchmarks/scc/run_matlab_phase_profile.sge"
test -f "$profiler"
test -f "$wrapper"

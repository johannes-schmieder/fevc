...
generate str24 oracle = "stata_kss_bc_exact"
...
file write `marker' "KSS_BC STATA MATLAB ORACLE PASS `source_commit'" _n
file close `marker'
di as result "KSS_BC STATA/MATLAB ORACLE PASS"
exit 0

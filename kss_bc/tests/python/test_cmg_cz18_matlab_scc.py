...
def test_cz18_matlab_harness_is_bundled() -> None:
    allowlist = (ROOT / "kss_bc" / "benchmarks" /
                 "scale_bundle_allowlist.txt").read_text().splitlines()
    expected = {
        "kss_bc/benchmarks/scc/cmg_cz18_matlab_prepare.do",
        "kss_bc/benchmarks/scc/cmg_cz18_matlab_run.m",
        "kss_bc/benchmarks/scc/run_cmg_cz18_matlab.sge",
        "kss_bc/benchmarks/scc/submit_cmg_cz18_matlab.sh",
        "kss_bc/benchmarks/scc/validate_cmg_cz18_matlab.py",
    }

...
ALLOWLIST = ROOT / "kss_bc/benchmarks/scale_bundle_allowlist.txt"
...
def test_hierarchy_scc_files_and_robust_families_are_bundled() -> None:
    ...
    assert {
        "kss_bc/benchmarks/scc/run_cmg_hierarchy.sge",
        "kss_bc/benchmarks/scc/submit_cmg_hierarchy.sh",
        "kss_bc/benchmarks/scc/validate_cmg_hierarchy.py",
        "shared/cmg/benchmarks/hierarchy_benchmark.do",
    } <= allowlist
    benchmark = (
        ROOT / "shared/cmg/benchmarks/hierarchy_benchmark.do"

...
void test_full_rhs_certificate()
{
    ...
    struct kssbc_fe_design scalar design
    struct kssbc_joint_design scalar joint
    struct kssbc_solver_backend scalar backend
    struct kssbc_solve_result scalar solved, direct, scalar_reference
    struct kssbc_solve_result scalar legacy, rejected, joint_solved
    struct kssbc_solve_result scalar joint_legacy, joint_rejected
    ...
    direct = kssbc__fe_solve_matrix_backend(
        design,full_rhs,tolerance,maxiter,backend)
    scalar_reference = kssbc__fe_solve_matrix_b0(
        design,full_rhs,tolerance,maxiter)
    ...
    rejected = kssbc__fe_solve_matrix(
    ...
    joint_solved = kssbc__joint_solve(
    ...
    joint_legacy = kssbc__joint_solve(
    ...
    joint_rejected = kssbc__joint_solve(

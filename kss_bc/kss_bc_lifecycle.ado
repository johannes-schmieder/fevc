*! kss_bc lifecycle prototype 0.1.0 16aug2026
...
program define kss_bc_lifecycle, rclass
    version 18.0
    ...
    quietly _kss_bc_lifecycle_memory, stage(before)
...
program define _kss_bc_lifecycle_memory, rclass
    version 18.0
    syntax [, STAGE(string)]
...
program define _kss_bc_lifecycle_timer_ids, rclass
    version 18.0
    local timers
    forvalues id = 51/69 {
...
program define _kss_bc_lifecycle_release_timers
    version 18.0
...
program define _kss_bc_lifecycle_phase, rclass
    version 18.0
    syntax, PHASE(string)
    ...
    quietly _kss_bc_lifecycle_phase_write,                      ///
...
// only _kss_bc_lifecycle_phase, which obtains the path from the environment.
program define _kss_bc_lifecycle_phase_write, rclass
    version 18.0

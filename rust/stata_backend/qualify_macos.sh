...
source_inputs=(
  ...
  "${package_dir}/fevc__rust_plan_receipt.ado"
  "${package_dir}/fevc__rust_reconcile_comp_v7.ado"
  "${package_dir}/fevc__rust_reconcile_exact_v7.ado"
  "${package_dir}/fevc__rust_post_comp_v7.ado"
  "${package_dir}/fevc__rust_post_exact_v7.ado"
  "${package_dir}/fevc__rust_capture_stayers.ado"
  "${package_dir}/fevc__rust_post_stayer_hybrid.ado"
  "${package_dir}/fevc__rust_macos.ado"
  "${package_dir}/fevc__rust_windows.ado"
  "${package_dir}/fevc__rust_linux.ado"
  "${package_dir}/fevc__rust_public_call.ado"
  ...
  "${package_dir}/fevc__rust_comp_batch_receipt.ado"
  "${package_dir}/fevc__rust_component_fetch.ado"
  "${package_dir}/fevc__rust_component_post.ado"
  "${package_dir}/fevc__failure_guidance.ado"

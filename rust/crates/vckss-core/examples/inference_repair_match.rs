...
//! Inference repair harness: frozen V1 match DGPs with explicit target diagnostics.
//!
...
mod campaign {
    ...
    const Q1_ROW_SCHEMA: &str = "fevc-inference-repair-match-row-v1";
    const Q1_PREFLIGHT_SCHEMA: &str = "fevc-match-inference-q1-design-preflight-v1";
    const Q1_MASTER_SEED: u64 = 0x4d61_7463_6851_31a1;
    const CONFIRMATION_SEED: u64 = 0xb734_90d2_6a18_ce55;
    const FIXED_FOLD_SEED: u64 = 0x862a_d51c_3f07_b994;

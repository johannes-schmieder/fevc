...
from vckss.benchmarks.matlab_scale.common import sha256_inventory
from vckss.benchmarks.scc.verify_numopt2_matlab_source import inventory_hash
from vckss.benchmarks.summarize_numopt2_matlab import (
    ADMISSION_HEADROOM,
    HARD_MEMORY_BYTES,
    matlab_pcg_status,
    parse_memory,
...
def test_matlab_comparator_files_are_in_scale_bundle() -> None:
    ...
    required = {
        "vckss/benchmarks/matlab_scale/common.py",
        "vckss/benchmarks/matlab_scale/monitor_process_tree.py",
        "vckss/benchmarks/matlab_scale/source_contract.json",
        "vckss/benchmarks/scc/numopt2_matlab_run.m",
        "vckss/benchmarks/scc/run_numopt2_matlab.sge",
        "vckss/benchmarks/scc/submit_numopt2_matlab.sh",
        "vckss/benchmarks/scc/validate_numopt2_matlab.py",
        "vckss/benchmarks/scc/verify_numopt2_matlab_source.py",
    }
...
def test_matlab_summary_has_no_corrected_estimate_equality_gate() -> None:
    source = (
        ROOT / "vckss/benchmarks/summarize_numopt2_matlab.py"
    ).read_text(encoding="utf-8")

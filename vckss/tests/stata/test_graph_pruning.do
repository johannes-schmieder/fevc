...
capture noisily vckss y, worker(relabeled_worker) firm(relabeled_firm) ///
...
vckss y, worker(worker_s) firm(firm_s) deletion(match)      ///
...
vckss y [fw=frequency], worker(worker_s) firm(firm_s)       ///

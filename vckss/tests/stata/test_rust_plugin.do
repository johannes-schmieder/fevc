...
capture noisily vckss_rust prepare empty_input1 empty_input2       ///
...
vckss_rust release `disconnected_handle'
vckss_rust snapshot
assert r(state) == 0
...
vckss_rust solve `handle', seed(91827) probes(6)                     ///
...
di as result "VCKSS RUST PLUGIN PASS"
exit 0

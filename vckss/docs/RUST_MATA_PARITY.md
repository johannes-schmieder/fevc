...
| Fixed-effect projection inference | qualified | qualified | no | exact Mata and sparse Rust generic-JLA routes; positive integer frequency weights match literal expansion; maintained-MATLAB weighted oracle; automatic constant; frequency or target mass; streamed covariance and complete residual/PSD/memory gates |

...
Target: `0.5.0-alpha.1`. Updated: 2026-08-29.
...
| Fixed-effect projection inference | qualified | deferred | no | observation-weighted or target-weighted projections with an automatic constant and an independent dense covariance oracle |

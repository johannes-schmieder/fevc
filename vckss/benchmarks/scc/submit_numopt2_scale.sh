...
test -f "$source_dir/vckss/benchmarks/scc/run_numopt2_scale.sge"
test -f "$source_dir/vckss/benchmarks/scc/numopt2_generate.do"
...
qsub_args=(-P welfgr -pe omp "$slots" -l "mem_per_core=${mem_per_core}G" \
  ...
  -v "$environment" "$source_dir/vckss/benchmarks/scc/run_numopt2_scale.sge")

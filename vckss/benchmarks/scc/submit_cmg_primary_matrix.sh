...
test "$source_dir" = "/projectnb/welfgr/vckss/bundles/$bundle_sha/source"
...
builder="$source_dir/vckss/benchmarks/scc/build_cmg_primary_manifest.py"
stata_submit="$source_dir/vckss/benchmarks/scc/submit_numopt2_scale.sh"
matlab_submit="$source_dir/vckss/benchmarks/scc/submit_numopt2_matlab.sh"
test -f "$builder"
test -x "$stata_submit"

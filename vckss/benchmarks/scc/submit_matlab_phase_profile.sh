...
case "$source_dir" in "/projectnb/welfgr/vckss/bundles/$bundle_sha/source") ;; *) exit 198 ;; esac
case "$input_csv" in /projectnb/welfgr/vckss/runs/*) ;; *) exit 198 ;; esac
...
profiler="$source_dir/vckss/benchmarks/separations_matlab_phase_profile.m"
wrapper="$source_dir/vckss/benchmarks/scc/run_matlab_phase_profile.sge"
test -f "$profiler"
test -f "$wrapper"

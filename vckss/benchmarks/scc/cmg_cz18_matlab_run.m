...
assert_cz(any(probes == [20 200]) && seed == 8675309,'Randomness', ...
    'CZ18 comparison requires P20 or P200 and seed 8675309.');
...
try
    ...
    [client_pid,pid_api] = cz18_process_id();
    spmd
        worker_pid = cz18_process_id();
...
function [pid,api] = cz18_process_id()

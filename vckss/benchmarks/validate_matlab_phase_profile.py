...
def validate(args: argparse.Namespace) -> None:
    ...
    require(f"VCKSS MATLAB PHASE PROFILE PASS: {args.label}" in application,
            "application success marker is missing")
    expected_pass = (
        f"VCKSS_MATLAB_PHASE_PROFILE_PASS {args.label} "
    ...
    print(
        "VCKSS MATLAB PHASE PROFILE EVIDENCE PASS; "

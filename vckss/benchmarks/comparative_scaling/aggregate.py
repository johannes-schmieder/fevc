...
RESULT_FIELDS = (
    ...
    "pool_teardown_seconds", "estimator_phase_peak_rss_bytes",
    ...
    "cmg_actual_retained_bytes", "max_complete_residual", "residual_acceptance",
    "solver_iterations", "cmg_backend", "corrected_worker", "corrected_firm",

...
```bash
./.venv/bin/python vckss/benchmarks/matlab_scale/validate_scc_job.py \
...
```bash
./.venv/bin/python vckss/benchmarks/matlab_scale/build_reference_receipt.py \
...
```bash
./.venv/bin/python vckss/benchmarks/matlab_scale/validate.py \
  --case <case.json> --case-sha256 <sha256> \
  --contract vckss/benchmarks/matlab_scale/source_contract.json \

...
VCKSS_SPIKE_WORK_ROOT=/private/tmp/vckss-mixed-2f94 \
...
`/private/tmp/vckss-mixed-2f94-run`, while the `f64` run omitted that variable
and wrote under `/private/tmp/vckss-f64-2f94-run`.

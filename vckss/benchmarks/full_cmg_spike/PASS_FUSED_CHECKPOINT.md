...
env VCKSS_CMG_ROOT=/Users/johannes/Git/CMG \
  VCKSS_SPIKE_WORK_ROOT=/private/tmp/vckss-pass-fused-build-c1ae402 \
  rust/full_cmg_spike/build_macos.sh
```

The exact direct command ran from
`/private/tmp/vckss-pass-fused-source-bound-c1ae402/direct`:
...
env VCKSS_PRIVATE_CMG_FULL_V1=1 \
  ...
  /Users/johannes/Git/varcomp_hdfe/vckss/vckss/benchmarks/full_cmg_spike/stata_run.do \
  /private/tmp/vckss-pass-fused-source-bound-c1ae402/package \
  /private/tmp/vckss-tol-ladder-e128/input/input.csv \
  /private/tmp/vckss-pass-fused-source-bound-c1ae402/direct/stata.csv \
...
`/private/tmp/vckss-pass-fused-source-bound-c1ae402/pass2`, added
`VCKSS_PRIVATE_CMG_PASS_FUSED_V1=1`, and changed the output to
`/private/tmp/vckss-pass-fused-source-bound-c1ae402/pass2/stata.csv`. The full

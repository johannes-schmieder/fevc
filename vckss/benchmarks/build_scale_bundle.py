...
REQUIRED_INFRASTRUCTURE = {
    PurePosixPath("vckss/benchmarks/build_scale_bundle.py"),
    PurePosixPath("vckss/benchmarks/kss_scale_fixtures.do"),
    PurePosixPath("vckss/benchmarks/kss_scale_fixtures.mata"),
    PurePosixPath("vckss/benchmarks/scale_bundle_allowlist.txt"),
    PurePosixPath("vckss/benchmarks/scc/deploy_scale_bundle.sh"),
    PurePosixPath("vckss/benchmarks/scc/cmg_cz18_matlab_prepare.do"),
    PurePosixPath("vckss/benchmarks/scc/cmg_cz18_matlab_run.m"),
    PurePosixPath("vckss/benchmarks/scc/kss_scale_driver.do"),
    PurePosixPath("vckss/benchmarks/scc/process_tree_rss.awk"),
    PurePosixPath("vckss/benchmarks/scc/run_kss_scale.sge"),
    PurePosixPath("vckss/benchmarks/scc/run_cmg_cz18_matlab.sge"),
    PurePosixPath("vckss/benchmarks/scc/submit_cmg_cz18_matlab.sh"),
    PurePosixPath("vckss/benchmarks/scc/submit_kss_scale.sh"),
    PurePosixPath("vckss/benchmarks/scc/validate_cmg_cz18_matlab.py"),
    PurePosixPath("vckss/benchmarks/scc/validate_kss_scale.py"),
}
REQUIRED_MATLAB_HARNESS = {
    PurePosixPath("vckss/benchmarks/matlab_scale/README.md"),
    PurePosixPath("vckss/benchmarks/matlab_scale/build_prepare_receipt.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/build_reference_receipt.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/build_wrapper_receipt.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/common.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/make_case.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/matlab_scale_cold.m"),
    PurePosixPath("vckss/benchmarks/matlab_scale/matlab_scale_run.m"),
    PurePosixPath("vckss/benchmarks/matlab_scale/matlab_scale_warm.m"),
    PurePosixPath("vckss/benchmarks/matlab_scale/monitor_process_tree.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/prepare_fixed_sample.do"),
    PurePosixPath("vckss/benchmarks/matlab_scale/run_matlab_scale.sge"),
    PurePosixPath("vckss/benchmarks/matlab_scale/run_prepare_fixed_sample.sge"),
    PurePosixPath("vckss/benchmarks/matlab_scale/source_contract.json"),
    PurePosixPath("vckss/benchmarks/matlab_scale/submit_matlab_scale.sh"),
    PurePosixPath("vckss/benchmarks/matlab_scale/validate.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/validate_scc_job.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/verify_case.py"),
    PurePosixPath("vckss/benchmarks/matlab_scale/verify_submission.py"),
}
REQUIRED_PACKAGE_METADATA = {
    PurePosixPath("vckss/vckss.pkg"),
    PurePosixPath("vckss/vckss.sthlp"),
    PurePosixPath("vckss/stata.toc"),
}
REQUIRED_DOCUMENTATION = {
    PurePosixPath("vckss/AGENTS.md"),
    PurePosixPath("vckss/CHANGELOG.md"),
    PurePosixPath("vckss/PLAN.md"),
    PurePosixPath("vckss/README.md"),
    PurePosixPath("vckss/TESTING.md"),
    PurePosixPath("vckss/benchmarks/README.md"),
    PurePosixPath("vckss/docs/ESTIMATOR_CONTRACT.md"),
    PurePosixPath("vckss/docs/FAILURES_AND_RETURNS.md"),
    PurePosixPath("vckss/docs/JLA_FINITE_PROJECTION.md"),
    PurePosixPath("vckss/docs/NUMERICAL_ARCHITECTURE.md"),
    PurePosixPath("vckss/docs/SOURCE_PROVENANCE.md"),
    PurePosixPath("vckss/cmg/docs/API_CONTRACT.md"),
    PurePosixPath("vckss/cmg/docs/MATH_CONTRACT.md"),
    PurePosixPath("vckss/cmg/docs/SOURCE_PROVENANCE.md"),
    PurePosixPath("vckss/cmg/STATUS.md"),
}
REQUIRED_CMG_SOURCE = {
    PurePosixPath("CODE_LICENSE.md"),
    PurePosixPath("LICENSES/GPL-3.0-only.txt"),
    PurePosixPath("vckss/cmg/AGENTS.md"),
    PurePosixPath("vckss/cmg/README.md"),
    PurePosixPath("vckss/cmg/generated/cmg_test.mata"),
    PurePosixPath("vckss/cmg/generated/manifest.json"),
    PurePosixPath("vckss/cmg/src/cmg_core.mata.in"),
    PurePosixPath("vckss/cmg/tools/assemble.py"),
    PurePosixPath("vckss/vckss_cmg.mata"),
}
...
def package_runtime_paths(root: Path) -> set[PurePosixPath]:
    payload, _ = read_regular_no_symlinks(
        root, PurePosixPath("vckss/vckss.pkg"))
    ...
    for line in payload.decode("utf-8").splitlines():
        ...
        shipped.add(PurePosixPath("vckss") / item)
...
def build(
    ...
    *,
    ...
    allowlist_relative = PurePosixPath(
        "vckss/benchmarks/scale_bundle_allowlist.txt")

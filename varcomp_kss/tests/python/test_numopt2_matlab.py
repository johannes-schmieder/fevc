...
from varcomp_kss.benchmarks.matlab_scale.common import sha256_inventory
from varcomp_kss.benchmarks.scc.verify_numopt2_matlab_source import inventory_hash
from varcomp_kss.benchmarks.summarize_numopt2_matlab import (
    ADMISSION_HEADROOM,
    HARD_MEMORY_BYTES,
    matlab_pcg_status,
    parse_memory,
...
def test_matlab_comparator_files_are_in_scale_bundle() -> None:
    allowlist = set(
        (ROOT / "varcomp_kss/benchmarks/scale_bundle_allowlist.txt")
        .read_text(encoding="utf-8")
        .splitlines()
    )
    required = {
        "varcomp_kss/benchmarks/matlab_scale/common.py",
        "varcomp_kss/benchmarks/matlab_scale/monitor_process_tree.py",
        "varcomp_kss/benchmarks/matlab_scale/source_contract.json",
        "varcomp_kss/benchmarks/scc/numopt2_matlab_run.m",
        "varcomp_kss/benchmarks/scc/run_numopt2_matlab.sge",
        "varcomp_kss/benchmarks/scc/submit_numopt2_matlab.sh",
        "varcomp_kss/benchmarks/scc/validate_numopt2_matlab.py",
        "varcomp_kss/benchmarks/scc/verify_numopt2_matlab_source.py",
    }
...
def test_matlab_summary_has_no_corrected_estimate_equality_gate() -> None:
    source = (
        ROOT / "varcomp_kss/benchmarks/summarize_numopt2_matlab.py"
    ).read_text(encoding="utf-8")

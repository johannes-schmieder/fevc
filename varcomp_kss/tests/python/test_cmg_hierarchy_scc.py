...
ALLOWLIST = ROOT / "varcomp_kss/benchmarks/scale_bundle_allowlist.txt"
...
def test_hierarchy_scc_files_and_robust_families_are_bundled() -> None:
    ...
    assert {
        "varcomp_kss/benchmarks/scc/run_cmg_hierarchy.sge",
        "varcomp_kss/benchmarks/scc/submit_cmg_hierarchy.sh",
        "varcomp_kss/benchmarks/scc/validate_cmg_hierarchy.py",
        "varcomp_kss/cmg/benchmarks/hierarchy_benchmark.do",
    } <= allowlist
    benchmark = (
        ROOT / "varcomp_kss/cmg/benchmarks/hierarchy_benchmark.do"

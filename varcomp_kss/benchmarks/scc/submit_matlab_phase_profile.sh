...
case "$source_dir" in "/projectnb/welfgr/varcomp-kss/bundles/$bundle_sha/source") ;; *) exit 198 ;; esac
case "$input_csv" in /projectnb/welfgr/varcomp-kss/runs/*) ;; *) exit 198 ;; esac
...
profiler="$source_dir/varcomp_kss/benchmarks/separations_matlab_phase_profile.m"
wrapper="$source_dir/varcomp_kss/benchmarks/scc/run_matlab_phase_profile.sge"
test -f "$profiler"
test -f "$wrapper"

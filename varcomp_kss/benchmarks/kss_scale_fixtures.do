...
program define vckss_scale_fixture, rclass
    version 18.0
    ...
    capture mata: assert(vckss_scale_fixture__api_level() == 2 & ///
        vckss_scale_fixture__build_id() ==                      ///
    ...
    mata: vckss_scale__stata_connect( ///

...
def validate(args: argparse.Namespace) -> None:
    ...
    require(f"VARCOMP_KSS MATLAB PHASE PROFILE PASS: {args.label}" in application,
            "application success marker is missing")
    expected_pass = (
        f"VARCOMP_KSS_MATLAB_PHASE_PROFILE_PASS {args.label} "
    ...
    print(
        "VARCOMP_KSS MATLAB PHASE PROFILE EVIDENCE PASS; "

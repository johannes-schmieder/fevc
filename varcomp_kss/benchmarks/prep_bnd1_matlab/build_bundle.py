...
ALLOWLIST = PurePosixPath(
    "varcomp_kss/benchmarks/prep_bnd1_matlab/bundle_allowlist.txt"
)
...
def read_paths(root: Path) -> list[PurePosixPath]:
    ...
    package = root / "varcomp_kss/varcomp_kss.pkg"
    runtime = {
        PurePosixPath("varcomp_kss") / line.removeprefix("f ").strip()

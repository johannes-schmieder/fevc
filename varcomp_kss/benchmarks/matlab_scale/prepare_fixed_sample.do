...
confirm file `"`source_root'/varcomp_kss/benchmarks/kss_scale_fixtures.do"'
confirm file `"`source_root'/varcomp_kss/benchmarks/kss_scale_fixtures.mata"'
...
quietly do `"`source_root'/varcomp_kss/benchmarks/kss_scale_fixtures.mata"'
quietly do `"`source_root'/varcomp_kss/benchmarks/kss_scale_fixtures.do"'

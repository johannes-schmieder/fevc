...
REQUIRED_INFRASTRUCTURE = {
    PurePosixPath("varcomp_kss/benchmarks/build_scale_bundle.py"),
    PurePosixPath("varcomp_kss/benchmarks/kss_scale_fixtures.do"),
    PurePosixPath("varcomp_kss/benchmarks/kss_scale_fixtures.mata"),
    PurePosixPath("varcomp_kss/benchmarks/scale_bundle_allowlist.txt"),
    PurePosixPath("varcomp_kss/benchmarks/scc/deploy_scale_bundle.sh"),
    PurePosixPath("varcomp_kss/benchmarks/scc/cmg_cz18_matlab_prepare.do"),
    PurePosixPath("varcomp_kss/benchmarks/scc/cmg_cz18_matlab_run.m"),
    PurePosixPath("varcomp_kss/benchmarks/scc/kss_scale_driver.do"),
    PurePosixPath("varcomp_kss/benchmarks/scc/process_tree_rss.awk"),
    PurePosixPath("varcomp_kss/benchmarks/scc/run_kss_scale.sge"),
    PurePosixPath("varcomp_kss/benchmarks/scc/run_cmg_cz18_matlab.sge"),
    PurePosixPath("varcomp_kss/benchmarks/scc/submit_cmg_cz18_matlab.sh"),
    PurePosixPath("varcomp_kss/benchmarks/scc/submit_kss_scale.sh"),
    PurePosixPath("varcomp_kss/benchmarks/scc/validate_cmg_cz18_matlab.py"),
    PurePosixPath("varcomp_kss/benchmarks/scc/validate_kss_scale.py"),
}
REQUIRED_MATLAB_HARNESS = {
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/README.md"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/build_prepare_receipt.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/build_reference_receipt.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/build_wrapper_receipt.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/common.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/make_case.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/matlab_scale_cold.m"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/matlab_scale_run.m"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/matlab_scale_warm.m"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/monitor_process_tree.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/prepare_fixed_sample.do"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/run_matlab_scale.sge"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/run_prepare_fixed_sample.sge"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/source_contract.json"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/submit_matlab_scale.sh"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/validate.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/validate_scc_job.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/verify_case.py"),
    PurePosixPath("varcomp_kss/benchmarks/matlab_scale/verify_submission.py"),
}
REQUIRED_PACKAGE_METADATA = {
    PurePosixPath("varcomp_kss/varcomp_kss.pkg"),
    PurePosixPath("varcomp_kss/varcomp_kss.sthlp"),
    PurePosixPath("varcomp_kss/stata.toc"),
}
REQUIRED_DOCUMENTATION = {
    PurePosixPath("varcomp_kss/AGENTS.md"),
    PurePosixPath("varcomp_kss/CHANGELOG.md"),
    PurePosixPath("varcomp_kss/PLAN.md"),
    PurePosixPath("varcomp_kss/README.md"),
    PurePosixPath("varcomp_kss/TESTING.md"),
    PurePosixPath("varcomp_kss/benchmarks/README.md"),
    PurePosixPath("varcomp_kss/docs/ESTIMATOR_CONTRACT.md"),
    PurePosixPath("varcomp_kss/docs/FAILURES_AND_RETURNS.md"),
    PurePosixPath("varcomp_kss/docs/JLA_FINITE_PROJECTION.md"),
    PurePosixPath("varcomp_kss/docs/NUMERICAL_ARCHITECTURE.md"),
    PurePosixPath("varcomp_kss/docs/SOURCE_PROVENANCE.md"),
    PurePosixPath("varcomp_kss/cmg/docs/API_CONTRACT.md"),
    PurePosixPath("varcomp_kss/cmg/docs/MATH_CONTRACT.md"),
    PurePosixPath("varcomp_kss/cmg/docs/SOURCE_PROVENANCE.md"),
    PurePosixPath("varcomp_kss/cmg/STATUS.md"),
}
REQUIRED_CMG_SOURCE = {
    PurePosixPath("CODE_LICENSE.md"),
    PurePosixPath("LICENSES/GPL-3.0-only.txt"),
    PurePosixPath("varcomp_kss/cmg/AGENTS.md"),
    PurePosixPath("varcomp_kss/cmg/README.md"),
    PurePosixPath("varcomp_kss/cmg/generated/cmg_test.mata"),
    PurePosixPath("varcomp_kss/cmg/generated/manifest.json"),
    PurePosixPath("varcomp_kss/cmg/src/cmg_core.mata.in"),
    PurePosixPath("varcomp_kss/cmg/tools/assemble.py"),
    PurePosixPath("varcomp_kss/varcomp_kss_cmg.mata"),
}
...
def package_runtime_paths(root: Path) -> set[PurePosixPath]:
    payload, _ = read_regular_no_symlinks(
        root, PurePosixPath("varcomp_kss/varcomp_kss.pkg"))
    ...
    for line in payload.decode("utf-8").splitlines():
        ...
        shipped.add(PurePosixPath("varcomp_kss") / item)
...
def build(
    ...
    *,
    ...
    allowlist_relative = PurePosixPath(
        "varcomp_kss/benchmarks/scale_bundle_allowlist.txt")

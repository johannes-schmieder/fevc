# `varcomp_kss`: KSS point estimates in Stata

`varcomp_kss` is an internal-development Stata 18/19 implementation of the
...
`varcomp_kss` is the only public command and package identity. No predecessor
alias is installed.

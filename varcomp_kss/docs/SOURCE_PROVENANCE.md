...
- `varcomp_kss/PLAN.md`: active milestone scope and completion gates.
- `varcomp_kss/docs/DECISIONS.md`: owner decisions and implementation boundaries.
- `varcomp_kss/docs/ESTIMATOR_CONTRACT.md`: current statistical contract.
- `varcomp_kss/cmg/docs/SOURCE_PROVENANCE.md`: package-owned CMG source ledger.

...
VCkss is distributed under GPL-3.0-only subject to the file-level notices and
...
in `vckss/cmg/docs/SOURCE_PROVENANCE.md` and its upstream file identities in
...
into VCkss. Implementations based on the published KSS formulas are
